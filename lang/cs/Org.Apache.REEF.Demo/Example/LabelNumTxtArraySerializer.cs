...
{
    public sealed class LabelNumTxtArraySerializer : IFileDeSerializer<LabelNumTxt[]>
    {
        [Inject]
        private LabelNumTxtArraySerializer()
        {
        }

        public LabelNumTxt[] Deserialize(ISet<string> filePaths)
        {
