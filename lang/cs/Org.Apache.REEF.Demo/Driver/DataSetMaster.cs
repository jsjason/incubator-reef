...
using Org.Apache.REEF.Demo.Example;
...
namespace Org.Apache.REEF.Demo.Driver
{
    ...
    public sealed class DataSetMaster : IDataSetMaster, IObserver<IAllocatedEvaluator>, IObserver<IActiveContext>
    {
        ...
        public IDataSet<string[]> Load(Uri uri)
        {
            ...
            return new DataSet<string[]>(_dataSetId, new DataSetInfo(_dataSetId, _partitionInfos.ToArray()), _partitionCollector);
        }
